  ...
  <body>
    <div class="container">
        ...
        <div class="search-container">
            <form class="d-flex" method="GET" action="manage_courses.php">
        ...
        <div class="button-group">
            <button class="btn btn-primary btn-custom"><a href="add_course.php" class="text-light text-decoration-none">Thêm Môn Học</a></button>
                        ...
                        echo '<tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="edit_course.php?id='.$row['id'].'" class="btn btn-warning btn-sm btn-custom">Sửa</a>
                                        <a href="delete_course.php?id='.$row['id'].'" class="btn btn-danger btn-sm btn-custom" onclick="return confirm(\'Bạn có chắc chắn muốn xóa?\')"><i class="fas fa-trash"></i> Xóa</a>
                                    </div>
                                </td>
                              </tr>';
                        $stt++;
